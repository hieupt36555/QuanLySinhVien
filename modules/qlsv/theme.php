...
function nv_demo_list($array_data)
{
    ...
    if(!empty($array_data)){
        foreach($array_data as $value){
            ...
            $value['url_detail']= nv_url_rewrite( NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&' . NV_NAME_VARIABLE . '=' . $module_name.'&'. NV_OP_VARIABLE. '=details&id='.$value['id']);
