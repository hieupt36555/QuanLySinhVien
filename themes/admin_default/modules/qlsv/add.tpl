<!-- BEGIN: main -->
<form id="form-news-content" class="form-inline m-bottom confirm-reload" action="" enctype="multipart/form-data" method="post">
    <div class="row">
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="birth" class="form-control" style="width:100%" value="{DATA.birth}" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="address" class="form-control" style="width:100%" value="{DATA.address}" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="email" class="form-control" style="width:100%" value="{DATA.email}" />
